...
const BROADCAST_CAMERA = {
  ...
  toyParkBroadcast: {
    ...
    startClose: { back: -6.2, side: 1.35, height: 24.0, lookAhead: 7.2, targetLift: 1.0, fov: 44, positionSmoothing: 0.14, targetSmoothing: 0.19, label: 'start: extra-high broadcast angle across the staged front pack' },
    firstCorner: { back: -8.8, side: 3.2, height: 32.0, lookAhead: 11.5, targetLift: 1.2, fov: 42, positionSmoothing: 0.065, targetSmoothing: 0.105, label: 'first corner: extra-high chase of the top three' },
    actionSpot: { back: -7.8, side: -3.4, height: 30.0, lookAhead: 10.0, targetLift: 1.1, fov: 41, positionSmoothing: 0.095, targetSmoothing: 0.13, label: 'mid race: extra-high cut to the tightest traffic / overtake pocket' },
    cinematicForward: { back: -12.2, side: 0.45, height: 34.0, lookAhead: 15.0, targetLift: 1.22, fov: 38, positionSmoothing: 0.085, targetSmoothing: 0.12, label: 'intermittent extra-high cinematic-forward sweep looking ahead along the route' },
    leaderDuel: { back: -10.0, side: 2.5, height: 32.5, lookAhead: 12.8, targetLift: 1.2, fov: 39, positionSmoothing: 0.06, targetSmoothing: 0.105, label: 'final: extra-high follow on leader plus nearest challenger' },
    momentZoom: { back: -5.4, side: 1.5, height: 22.0, lookAhead: 7.2, targetLift: 1.0, fov: 36, positionSmoothing: 0.25, targetSmoothing: 0.28, label: 'collision / overtake / lead-change short zoom punch from an extra-high angle' },
  },
